...
namespace FindHost
{
	public ref class Form1 : public Form
	{
		...
		void InitializeComponent(void)
		{
			...
			this->treeView1->Size = System::Drawing::Size(146, 249);
			...
			this->listView1->Size = System::Drawing::Size(289, 249);
		...
		{
			Tools::CheckHost::CheckingHost(textBox1->Text, richTextBox1, button1, timer1, progressBar1);
		...
		{
					 textBox1->Text += tabControl1->TabPages[1];
		}
};
}